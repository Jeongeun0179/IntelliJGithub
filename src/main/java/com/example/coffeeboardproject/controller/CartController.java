...
public class CartController {
    ...
    public String list(HttpServletRequest req, Model model) {
        ...
        if (req.getParameter("coffee_id") != null) {
            cart.setCoffee_id(Integer.parseInt(req.getParameter("coffee_id")));
            cart.setOrder_id( 0 );
            cart.setQuantity( 1 );
            ...
            coffee.setCoffee_id(Integer.parseInt(req.getParameter("coffee_id")));
            ...
            //System.out.println("quantity3: " + cart.getQuantity());
